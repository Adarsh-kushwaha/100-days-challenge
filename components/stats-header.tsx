...
export function StatsHeader({
  ...
  return (
    <header className="w-full max-w-3xl mx-auto mb-8 text-center space-y-4 pt-8 px-4">
      <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground bg-gradient-to-r from-green-600 to-green-100 bg-clip-text text-transparent">
        100 Days Challenge
      </h1>
